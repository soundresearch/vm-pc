...
const sounds = {
    cancel: new Audio('/vm-pc/pers_cancel.wav'),
    check: new Audio('/vm-pc/pers_check.wav'),
    emoji: new Audio('/vm-pc/pers_emoji.wav'),
};
...
export function Model({ setIsLoading, setMessage, resetPos, setResetPos, setAnimationComplete, selectedButton, setSelectedButton, setCursorStyle, ...props }) {
    const { nodes, materials } = useGLTF('/vm-pc/vending-machine.glb');
